...
import { Modal } from '../../overlay/modal/modal.js';
...
export class Navbar extends Component {
  // ✅ HTML embebido (con comentarios preservados)
  static getTemplate() {
    return `
      ...
      <ul class="space-y-2">
        ...
        <li>
          <div
            ...
            <ul id="mod-system"
              ...
              <li><a href="#system-users" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Usuarios</a></li>
              <li><a href="#system-roles" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Roles</a></li>
              <li><a href="#system-codes" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Códigos</a></li>
              <li><a href="#system-audit" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Auditoría</a></li>
            </ul>
          </div>
        </li>
        ...
        <li>
          <div
            ...
            <ul id="mod-planification"
              class="rounded-b-lg pl-9 py-6 space-y-1 hidden hover:bg-gradient-to-tr hover:from-[rgb(var(--body-from))] hover:to-[rgb(var(--body-to))] group-hover:bg-gradient-to-tr group-hover:from-[rgb(var(--body-from))] group-hover:to-[rgb(var(--body-to))]">
              <li><a href="#planification-university" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Universidad</a></li>
              <li><a href="#planification-localities" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Localidades</a></li>
              <li><a href="#planification-faculties" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Facultades</a></li>
              <li><a href="#planification-departments" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Departamentos</a></li>
              <li><a href="#planification-careers" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Carreras</a></li>
              <li><a href="#planification-pensums" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Pensums</a></li>
              <li><a href="#planification-subjects" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Materias</a></li>
              <li><a href="#planification-cycles" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Ciclos</a></li>
              <li><a href="#planification-dates" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Fechas
                Académicas</a></li>
              <li><a href="#planification-modalities" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Modalidades</a></li>
              <li><a href="#planification-titles" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Títulos</a></li>
              <li><a href="#planification-degrees" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Grados</a></li>
              <li><a href="#planification-service" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Servicio
                Social</a></li>
              <li><a href="#planification-documents" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Documentos</a></li>
              <li><a href="#planification-evaluation-instruments" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Instrumentos</a></li>
            </ul>
          </div>
        </li>
        ...
        <li>
          <div
            ...
            <ul id="mod-ar"
              class="rounded-b-lg pl-9 py-6 space-y-1 hidden hover:bg-gradient-to-tr hover:from-[rgb(var(--body-from))] hover:to-[rgb(var(--body-to))] group-hover:bg-gradient-to-tr group-hover:from-[rgb(var(--body-from))] group-hover:to-[rgb(var(--body-to))]">
              <li><a href="#ar-students" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Estudiantes</a></li>
              <li><a href="#ar-career-enrollments" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripciones
                Carreras</a></li>
              <li><a href="#ar-cycle-enrollments" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripciones
                Ciclos</a></li>
              <li><a href="#ar-course-enrollments" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripciones
                Cursos</a></li>
              <li><a href="#ar-student-performance" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Rendimiento</a></li>
            </ul>
          </div>
        </li>
        ...
        <li>
          <a href="#tp-courses"
            ...
            <div
              ...
              <span class="font-medium text-[rgb(var(--button-from))] transition-all duration-300 select-none group-hover:text-white drop-shadow">
                Cursos
              </span>
            </div>
          </a>
        ...
        <li>
          <div
            ...
            <ul id="mod-sp-enrollments"
              class="rounded-b-lg pl-9 py-6 space-y-1 hidden hover:bg-gradient-to-tr hover:from-[rgb(var(--body-from))] hover:to-[rgb(var(--body-to))] group-hover:bg-gradient-to-tr group-hover:from-[rgb(var(--body-from))] group-hover:to-[rgb(var(--body-to))]">
              <li><a href="#sp-enrollments-cycles" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripción
                Ciclos</a></li>
              <li><a href="#sp-enrollments-courses" class="block px-3 py-1 text-[rgb(var(--button-from))] rounded hover:text-[rgb(var(--text-from))]">Inscripción
                Materias</a></li>
            </ul>
          </div>
        </li>
        ...
        <li>
          <a href="#profile"
            ...
            <div class="flex items-center gap-5 px-5 py-4 transition-colors duration-300 inner rounded-xl group-hover:bg-gradient-to-r group-hover:from-[rgb(var(--button-from))] group-hover:to-[rgb(var(--button-to))]"
              id="nav-profile">
              <div class="flex items-center justify-center h-14 w-14 profile-avatar" id="profile-avatar"></div>
              <span
                class="flex-1 font-medium text-[rgb(var(--button-from))] transition-all duration-300 select-none group-hover:bg-clip-text group-hover:text-white group-hover:font-medium drop-shadow">
                Mi Perfil
              </span>
            </div>
          </a>
...
<template id="tmpl-logout-confirm">
  ...
  constructor(opts = {}) {
    ...
    if (!host) {
      ...
      super({ host: document.createElement('div'), /* url: opts.url || ROUTES.components.layout.navbar.html, */ autoRender: false });
      this._retryRender();
      return;
    }
    ...
    super({
      host,
      /* url: opts.url || ROUTES.components.layout.navbar.html */
    });
  ...
  async _render() {
    try {
      ...
      // ✅ Ahora: clon desde template embebido
      ...
      // Creamos un fragmento editable para filtrar por rol ANTES de inyectar
  ...
  async attachLogoutHandler() {
    ...
    btn.addEventListener('click', async () => {
      // ❌ Antes: dynamic import con ROUTES
      // ✅ Ahora: usamos las clases ya importadas
