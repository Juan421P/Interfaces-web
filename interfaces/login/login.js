...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function showEmailError(msg) {
        ...
        emailInput.classList.add('border', 'border-red-400');
        emailTtip.show();
    }

    function clearEmailError() {
        emailTooltip.classList.add('hidden');
        emailInput.classList.remove('border', 'border-red-400');
        emailTtip.hide();
    }
    ...
    function showPasswordError(msg) {
        ...
        passwordInput.classList.add('border', 'border-red-400');
        passwordTtip.show();
    }

    function clearPasswordError() {
        passwordTooltip.classList.add('hidden');
        passwordInput.classList.remove('border', 'border-red-400');
        passwordTtip.hide();
    }
