...
export default class MainInterface extends Interface {
      ...
      <main class="flex flex-col min-h-screen p-10 md:ml-80">
        <div class="w-full space-y-8">
          <div class="bg-gradient-to-bl from-[rgb(var(--card-from))] to-[rgb(var(--card-to))] shadow-md rounded-xl p-6 flex items-center gap-6">
            <div id="main-avatar" class="w-14 h-14 rounded-full bg-gradient-to-tr from-[rgb(var(--body-from))] to-[rgb(var(--body-to))] flex items-center justify-center drop-shadow flex-shrink-0"></div>
            <div class="flex-shrink-1">
              <p id="main-welcome" class="text-lg font-semibold text-transparent select-none bg-gradient-to-r from-[rgb(var(--button-from))] to-[rgb(var(--button-to))] bg-clip-text drop-shadow"></p>
              <p id="main-role" class="text-sm text-transparent select-none bg-gradient-to-r from-[rgb(var(--text-from))] to-[rgb(var(--text-to))] bg-clip-text drop-shadow"></p>
              <span id="main-date" class="block mt-1 text-xs text-transparent select-none bg-gradient-to-r from-[rgb(var(--text-from))] to-[rgb(var(--text-to))] bg-clip-text drop-shadow"></span>
            </div>
          </div>
          <div class="px-5 py-4 border border-[rgb(var(--off-from))] rounded-lg bg-gradient-to-tr from-[rgb(var(--body-from))] to-[rgb(var(--body-to))] drop-shadow">
            <span class="bg-gradient-to-r from-[rgb(var(--text-from))] to-[rgb(var(--text-to))] bg-clip-text text-transparent select-none drop-shadow">
  ...
  async _loadUserData() {
    const user = AuthGuard.user; // ✅ ahora existe por el getter
    ...
    const roleName  = user.roleName  || 'Usuario';  // ✅ por nombre
